  ...
  private pageList: PageModel[] = [
    ...
    } as PageModel,
    {
      ...
      wordPressPostModules: [
        ...
        generateDummyInfoHeaderModule(
          ...
          "left",
          "https://d2ddoduugvun08.cloudfront.net/items/0N3x3K350J310c0g2B1i/Image%202019-05-24%20at%202.35.36%20PM.png?X-CloudApp-Visitor-Id=3342233&v=651d9d88",
          "left",
    ...
    } as PageModel,
    {
      ...
      wordPressPostModules: [
        ...
        generateDummyRelatedProductsSlider("Gere"),
        generateNotYetImplemented("Related Recipe Module"),
        generateDummyNewsletterModule(),
        generateDummyFooterModule()
      ]
