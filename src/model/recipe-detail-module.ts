  ...
  return {
    socialMediaButtons: {
      ...
      pinterest: {
        ...
        title: titleSharing,
        media:
          'https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/image-featured.1ebed0b8.jpg',
      },
    },
    howTo: {
      steps: [
    ...
    // ],
    ingredientsPics: [
      'https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/image-featured.jpg',
      'https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/small-card3.png',
      'https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/card2.jpg',
    ],
