...
export const generateDummyContactModule = (): ContactModule => {
  return {
     ...
     contactAddressInfo:{shopName:"TerraSana",street:"Waaier 10", postalCode:"2451VV",city:"LEIMUIDEN"},
     mailingAddress:"Postadres",
     mailingAddressInfo:{shopName:"TerraSana" ,street:"Postbus 70", postalCode:"2450 AB" , city:"LEIMUIDEN"},
     phone:"Telefonisch",
     generalAndSales:{contactName:"Algemeen & verkoop",phone:"+31 (0) 172 - 50 33 33"},
