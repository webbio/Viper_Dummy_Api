...
const generateProductCardsUpTo7 = (amount: number): ProductLineOverviewCard[] => {
  ...
  if (amount === 1) {
    productList.push({
      ...
      link: "/",
      image: "https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/productLineOverview/1.jpg",
  ...
  if (amount >= 2) {
    productList.push({
      buttonText: "Bekijk deze producten",
      link: "/",
      image: "https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/productLineOverview/2.jpg",
  ...
  if (amount >= 3) {
    productList.push({
      buttonText: "Bekijk deze producten",
      link: "/",
      image: "https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/productLineOverview/3.png",
  ...
  if (amount >= 5) {
    productList.push({
      buttonText: "Bekijk deze producten",
      link: "/",
      image: "https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/productLineOverview/4.jpg",
  ...
  if (amount >= 6) {
    productList.push({
      buttonText: "Bekijk deze producten",
      link: "/",
      image: "https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/productLineOverview/5.jpg",
  ...
  if (amount >= 7) {
    productList.push({
      buttonText: "Bekijk deze producten",
      link: "/",
      image: "https://viper-development-images.s3-eu-west-1.amazonaws.com/Terrasana/productLineOverview/6.jpg",
      title: "Biodrop?",
      content: "Integer non est molestie massa interdum fringilla. Donec finibus arcu tellus...",
      categoryDetail: categories[1],
      diet: diets[1],
